...
def _sequential_duplicate_config(
    config_factory, **tracker_overrides: object
) -> AppConfig:
...
def test_sequential_duplicate_allows_color_differs_when_not_required(
    ...
    deduplicate_classified_tracks(
        _sequential_duplicate_config(
            config_factory, sequential_duplicate_require_same_color=False
        ),
        store,
    )
...
def test_sequential_duplicate_allows_generation_differs_when_not_required(
    ...
    deduplicate_classified_tracks(
        _sequential_duplicate_config(
            config_factory, sequential_duplicate_require_same_generation=False
        ),
        store,
    )
...
def test_sequential_duplicate_allows_variation_differs_when_not_required(
    ...
    deduplicate_classified_tracks(
        _sequential_duplicate_config(
            config_factory, sequential_duplicate_require_same_variation=False
        ),
        store,
    )
