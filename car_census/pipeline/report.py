...
from car_census.stats.counts import aggregate_counts, write_counts_csv, write_counts_json
from car_census.storage.run_store import RunStore
from car_census.types import CountEvent, MMRResult
...
def generate_reports(run_store: RunStore) -> dict[str, object]:
    ...
    payload = aggregate_counts(labels_by_track=labels, counted_track_ids=counted_track_ids)
